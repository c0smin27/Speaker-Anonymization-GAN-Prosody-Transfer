...
- **GAN-based artificial embedding generator** that produces synthetic, non-identifiable voice embeddings
- **prosody transfer module** that preserves natural rhythm and intonation
